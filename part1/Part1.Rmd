...
We have now looked countries ranked by ARV coverage and we have seen the impact of the introduction of ARVs.  


We can also look at the rates of HIV infection in different African countries.  

**I think we should rather do this with leaflet.** But, the idea of what to expect.
...
merge.shp.coef <- merge(africa.shp.f, HIV_rate_2016, by.x = "id", by.y = "Country", all.x=TRUE)
