...
We have the sequence `r paste0(WT, collapse = "")` which we created in the cell block above as codons for clarity.  We can now translate this seqeunce using the codon table or some function.
...
The resulting mutant sequenc is: `r MUT`  and if we now translate that we get
